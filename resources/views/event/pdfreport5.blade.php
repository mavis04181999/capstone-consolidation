...
<body>
    ...
    <section class="body">
        <div class="event-report">
            ...
            <p style="text:align: justify;"><strong>Instruction:&nbsp;  Please check [ / ] in the appropriate column your evaluation rating on the indicators below. The rating scales ranges from 1 - 5, where 5 - Excellent, 4 - Very Satisfactory, 3 - Satisfactory, 2 - Fair, 1 - Poor</strong></p>
            ...
            @switch($overAllRating)
                ...
                @case($overAllRating >= 2)
                    <p><strong>Overall Rating: {{ $overAllRating.' / '. $maxOption }} - Fair</strong></p>
                    @break
