...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-heading">        
            <i class="fa fa-calendar-o mr-2"></i>Organizer Dashboard
        </div>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <section id="event-list">
                    <div class="row">
                        <h4 class="text-dark"><i class="fa fa-list-alt"></i> Events: </h4>
                    </div>
                        ...
                        <a href="{{ route('show.event', ['event' => $event->id ]) }}" class="col-sm-9 form-group" style="text-decoration: none; ">
                            <div class="card mb-3 py-1 border-bottom-primary ">
                                <div class="card-body text-center">
                                    ...
                                    <small><i class="fa fa-user"></i> Organizer: ( {{ $event->organizer->username }} )</small>
                                </div>                                
                            </div>
                        </a>
                        @endforeach
