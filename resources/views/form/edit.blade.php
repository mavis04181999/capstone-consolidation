    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                {{-- custom form builder vue script here --}}
                <custom-form-builder event_id="{{ $event->id }}" event_name="{{ $event->event_name }}" ></custom-form-builder>
...
<script>
    console.log('custom form builder loaded successfully');
</script>
