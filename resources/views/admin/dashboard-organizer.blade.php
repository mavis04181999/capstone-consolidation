                            ...
                            <tbody>
                                @if (count($organizers) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$organizer->firstname ? $organizer->firstname : '' }}</td>
                                        <td>{{$organizer->lastname ? $organizer->lastname : '' }}</td>
                                        <td>{{$organizer->email ? $organizer->email : '' }}</td>
                                        <td>{{$organizer->username ? $organizer->username : '' }}</td>
                                        <td>{{$organizer->temppassword ? $organizer->temppassword : ''}}</td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-info"
                                            data-organizer="{{ $organizer }}"
                                            onclick="updateOrganizer(event)">Edit <i class="fa fa-pencil-square-o"></i></button>
                                            <button onclick="deleteOrganizer(event)" type="button" class="btn btn-sm btn-danger"
                                            data-organizer="{{ $organizer }}"
